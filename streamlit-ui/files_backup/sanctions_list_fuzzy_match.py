...
# File paths for customer and sanctions data
...
# Define a function for fuzzy matching, handling potential misspellings
def fuzzy_match(row, sanctions_data, name_threshold=80):
...
matches = pd.concat(
    customer_data.apply(lambda row: fuzzy_match(row, sanctions_data), axis=1).tolist()
